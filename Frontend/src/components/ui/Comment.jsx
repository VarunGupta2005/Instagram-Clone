...
const Comment = ({ setDialog, showComment, post }) => {
        ...
        <div className='flex w-full h-full' name='comment-container'>
          ...
          <div name="right-side" className='flex flex-col w-1/2 h-full bg-[#FFFFFF15] flex-shrink-0'>
            <div className='flex w-full items-center pr-3 pl-3 pt-4 pb-4 justify-between border-b dark:border-[#FFFFFF50] flex-shrink-0'>
              ...
              {/* The Dialog and MoreHorizontal icon have been removed from here */}
            </div>
            ...
            <div className='w-full px-4 pt-2 pb-4 border-t dark:border-[#FFFFFF50] flex-shrink-0'>
              ...
              <div className='flex gap-3 items-center'>
                <textarea
                  ...
                  className='w-full bg-transparent resize-none overflow-y-auto text-sm focus:outline-none'
                  rows="1"
                />
                <button
                  className={`font-semibold ${text.trim() ? 'text-blue-500 cursor-pointer' : 'text-gray-500 opacity-50 cursor-not-allowed'}`}
                  disabled={!text.trim()} onClick={sendComment}
                >
                  Post
                </button>
              </div>
