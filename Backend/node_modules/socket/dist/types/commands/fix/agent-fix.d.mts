...
export type InstallPhaseHandler = (editablePkgJson: EditablePackageJson, name: string, oldVersion: string, newVersion: string, vulnerableVersionRange: string, options: FixOptions) => Promise<void>;
...
}, ciEnv: CiEnv | null, openPrs: PrMatch[], options: FixOptions): Promise<CResult<{
    fixed: boolean;
}>>;
