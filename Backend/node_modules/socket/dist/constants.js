...
const LAZY_ENV = () => {
  const {
    envAsBoolean,
    envAsString
  } = require$1('../external/@socketsecurity/registry/lib/env');
  const {
    env
  } = process;
  ...
  return Object.freeze({
    ...
    INLINED_CYCLONEDX_CDXGEN_VERSION: envAsString("11.4.1"),
    ...
    INLINED_SOCKET_CLI_VERSION: envAsString("1.0.1"),
    // Comp-time inlined Socket package version hash.
    // The '@rollup/plugin-replace' will replace "process.env['INLINED_SOCKET_CLI_VERSION_HASH']".
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString("1.0.1:ad6e860:4d7f02b6:pub"),
...
const lazySocketAppDataPath = () => {
  ...
  if (!dataHome) {
    if (WIN32) {
      const logger = require$1('../external/@socketsecurity/registry/lib/logger');
...
//# debugId=de23540f-12fd-4f2d-903e-cd644e0fc6fa
